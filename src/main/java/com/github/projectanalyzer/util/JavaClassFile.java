...
public class JavaClassFile {
    ...
    public static class ConstantPool {
        ...
        private ConstantInfo readConstantInfo(int index, ClassReader reader) {
            ...
            switch (tag) {
                ...
                case ConstantInfo.CONSTANT_METHOD_TYPE:
                    ...
                    break;
                case ConstantInfo.CONSTANT_MODULE:
                    constantInfo = new ConstantModule(index, reader);
                    break;
                case ConstantInfo.CONSTANT_PACKAGE:
                    constantInfo = new ConstantPackage(index, reader);
                    break;
                default: {
                    //用户可以自定义解析器
        ...
        public ConstantMethodRefInfo getConstantMethodRefInfo(int index) {
            return (ConstantMethodRefInfo) getConstantInfo(index);
        }

        public ConstantInterfaceMethodRefInfo getConstantInterfaceMethodRefInfo(int index) {
            return (ConstantInterfaceMethodRefInfo) getConstantInfo(index);
        }

        public boolean exist(int index, Class type) {
            if (index > 0 && index < constants.length) {
                return type.isAssignableFrom(constants[index].getClass());
            } else {
                return false;
            }
        }
        ...
        public class ConstantMethodRefInfo implements ConstantInfo {
            ...
            public ConstantMemberRefInfo getMemberRefInfo() {
                return memberRefInfo;
            }
        ...
        public class ConstantNameAndTypeInfo implements ConstantInfo {
            ...
            public String getName() {
                return getUtf8ForToString(nameIndex);
            }

            public String getDescriptor() {
                return getUtf8ForToString(descriptorIndex);
            }
        ...
        public class ConstantModule implements ConstantInfo {
            private int nameIndex;
            private int index;

            public ConstantModule(int index, ClassReader reader) {
                this.index = index;
                nameIndex = reader.readUint16();
            }
        ...
        public class ConstantPackage implements ConstantInfo {
            private int nameIndex;
            private int index;

            public ConstantPackage(int index, ClassReader reader) {
                this.index = index;
                nameIndex = reader.readUint16();
            }
    ...
    public static class Member {
        ...
        public JavaClassFile getDeclaringClassFile() {
            return classFile;
        }
    ...
    public static class ClassReader implements Closeable {
        ...
        public ClassReader(String path, String fileName) throws IOException {
            this(new FileInputStream(path + File.separator + fileName));
        }
    ...
    public static class Opcodes {
        ...
        public boolean existInt8(int index) {
            return exist(index);
        }

        public boolean existInt16(int index) {
        ...
        public int readUint16(int index) {
            int value = (short) (opcodes[index] << 8 | opcodes[index + 1] & 0xFF);
            return value & 0x0FFFF;
        }

        public short readUint8(int index) {
            short value = opcodes[index];
            return (short) (value & 0x0FF);
        }
    ...
    public class Attribute extends LinkedHashMap<String, Object> {
        ...
        public class Annotation {
            ...
            public String getTypeName() {
                return constantPool.getUtf8ForToString(typeIndex);
            }
            ...
            public class ClassElementValue extends ElementValue {
                ...
                public String value() {
                    return constantPool.getUtf8ForToString(classInfoIndex);
                }
            ...
            public class StringElementValue extends ElementValue {
                ...
                public String value() {
                    return constantPool.getUtf8ForToString(constValueIndex);
                }
            ...
            public class ByteElementValue extends ElementValue {
                ...
                public int value() {
                    return constantPool.getInteger(constValueIndex);
                }
            ...
            public class DoubleElementValue extends ElementValue {
                ...
                public double value() {
                    return constantPool.getDouble(constValueIndex);
                }
            ...
            public class EnumElementValue extends ElementValue {
                ...
                public String constName() {
                    return constantPool.getUtf8ForToString(constNameIndex);
                }

                public String typeName() {
                    return constantPool.getUtf8ForToString(typeNameIndex);
                }
